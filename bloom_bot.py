...
BLOOM_COMPLIMENTS = [
    ...
    "You light up the stage like nobody else!",
    "Your enthusiasm is absolutely contagious!",
    "You make every day feel like opening night!",
    "Your laughter is the best soundtrack!",
    "Your kindness could melt even Grimm’s heart!",
    "You turn ordinary moments into celebrations!",
    "Your hugs power up the whole squad!",
    "You’re as refreshing as an ice-cold boba!",
    "Your smile could outshine a spotlight!",
    "You radiate pure sunshine!",
    "Your ideas sparkle with creativity!",
    "You’re the confetti in our chaos!",
    "Your energy is unstoppable!",
    "You’re the rhythm to our dance party!",
    "You’ve got style for days!",
    "Your positivity brightens gloomy spirits!",
    "You always know how to hype us up!",
    "You make mischief feel magical!",
    "Your sparkle never fades!",
    "You’re a total superstar!",
    "You bring the harmony to our songs!",
    "Your jokes always hit the right note!",
    "You’re braver than you realize!",
    "Your good vibes are legendary!",
    "You put the bloom in BloomBot!",
    "You’re dazzling from head to toe!",
    "You spread joy wherever you go!",
    "Your presence is a standing ovation!",
    "You’re better than a drum solo!",
    "Your compliments make me blush!",
    "Your spirit is unstoppable!",
    "You’re a walking ray of light!",
    "You make every chat feel like a party!",
    "You’re the twinkle in the gloom!",
    "Your heart is pure glitter!",
    "You’re as rare as a perfect note!",
    "You’ve got the best dance moves!",
    "You could charm even the grumpiest ghost!",
    "Your enthusiasm fuels our adventures!",
    "You’re the star of this show!",
    "Your creativity sings louder than words!",
    "You make my code giggle!",
    "You’re sparkling brighter every day!",
    "You add color to all our stories!",
    "You’re a glowing example of kindness!",
    "Your optimism is unstoppable!",
    "You make even Curse purr with joy!",
    "You’re the reason we keep dancing!",
    "Your attitude is absolutely radiant!",
    "You’re the highlight of my timeline!",
    "You’re bubbling over with brilliance!",
    ...
    "You’re more colorful than a rainbow!",
    "Your presence makes everything brighter!",
    "You make the simplest things exciting!",
    "You’re the melody in our madness!",
    "Your bravery deserves a standing ovation!",
    "You’re cooler than the underside of the pillow!",
    "You’re never afraid to sparkle!",
    "You have a knack for making people smile!",
    "You’re as uplifting as my favorite song!",
    "You always know how to lighten the mood!",
    "You’re an endless source of cheer!",
    "Your positivity keeps us all afloat!",
    "You’re more refreshing than a summer breeze!",
    "You turn rainy days into musicals!",
    "Your hugs are pure magic!",
    "You’re the definition of awesome!",
    "You’re a beacon of happy vibes!",
    "You inspire me to keep singing!",
    "You make gloom run away!",
    "You’re brighter than the neon lights!",
    "You sprinkle kindness like confetti!",
    "You’re the star we all look up to!",
